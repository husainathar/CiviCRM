...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:@localhost:3306/compucorp?new_link=true');
  }
}
...
$civicrm_root = 'C:/wamp/www/compucorp/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'C:/wamp/www/compucorp\\sites\\default\\files\\civicrm\\templates_c\\');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '6e436e52edaa2956b4667b271ff8cfd9');
}
...
// define( 'CIVICRM_MAIL_LOG', 'C:/wamp/www/compucorp\\sites\\default\\files\\civicrm\\templates_c\\/mail.log');
// }
